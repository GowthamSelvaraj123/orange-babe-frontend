    ...
    return (
        <div className="bg-white py-6 flex flex-col gap-6">
            <div className="container mx-auto px-4">
                {/* Top Big Banner */}
                <Link to="/products" className="block w-full aspect-[21/7] md:aspect-[21/6] overflow-hidden rounded-sm mb-6 border border-gray-100 shadow-sm">
                    <img src="/placeholder.svg" alt="New Arrivals" className="w-full h-full object-cover" />
                </Link>

                {/* Two Gender Banners */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    <Link to="/products?category=Boy" className="relative aspect-[21/9] md:aspect-[21/10] overflow-hidden rounded-sm group border border-gray-100 shadow-sm">
                    ...
                    <Link to="/products?category=Girl" className="relative aspect-[21/9] md:aspect-[21/10] overflow-hidden rounded-sm group border border-gray-100 shadow-sm">
